...
color b
chcp 65001 >nul
title OptiClub V6.6-BETA -One Click Optimizer  05-22-2026 -https://discord.gg/Np77z4C9qs
...
reg add "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Image File Execution Options\vrmonitor.exe" /v "FrontEndHeapDebugOptions" /t REG_DWORD /d "0x04" /f
reg add "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Image File Execution Options\EpicGamesLauncher.exe" /v "FrontEndHeapDebugOptions" /t REG_DWORD /d "0x04" /f
echo Done!
...
md %UserProfile%\Desktop\OptiClub\DisableAnimations\
powershell Invoke-WebRequest "https://github.com/ZaneLS/MSI_UTIL_V3/raw/refs/heads/main/dfsfsfd.reg" -OutFile "%UserProfile%\Desktop\OptiClub\DisableAnimations\DisableAnimations.reg"
start powershell "" "%UserProfile%\Desktop\OptiClub\DisableAnimations\DisableAnimations.reg"
...
timeout /t 3 /nobreak > NUL
powershell Invoke-WebRequest "https://raw.githubusercontent.com/ZaneLS/OOSU-Config/refs/heads/main/Opticlub-V6.7.cfg" -OutFile "%UserProfile%\Desktop\OptiClub\OOSU10\Cfg\Opticlub-V6.7.cfg"
set OOSUPath="%UserProfile%\Desktop\OptiClub\OOSU10\OOSU10.exe"
set ConfigPath="%UserProfile%\Desktop\OptiClub\OOSU10\Cfg\Opticlub-V6.7.cfg"
